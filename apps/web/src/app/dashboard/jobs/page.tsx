...
export const VERIFIED_JOB_DATABASE: MatchedJobOpportunity[] = [
  ...
  },
  {
    ...
    title: "Software & Analytics Associate",
    company: "Innovaccer",
    ...
    skills: ["SQL", "Python", "Data Visualization", "Pandas", "Power BI", "FastAPI"],
  ...
  },
  {
    ...
    skills: ["Power BI", "SQL", "Python", "Azure", "Data Visualization", "Machine Learning"],
    applyUrl: "https://careers.microsoft.com/",
  },
  {
    id: "job-google-swe-sf",
    ...
    matchScore: 95,
    recruiterCallRate: "94% Recruiter Call Rate",
    platformSource: "Company Careers",
    recruiterName: "Sarah Vance",
    recruiterTitle: "Technical Staffing Lead — Google Cloud",
    recruiterEmail: "recruiting-cloud@google.com",
    recruiterLinkedInSearch: "https://www.linkedin.com/search/results/people/?keywords=Google+Cloud+Technical+Recruiter",
    skills: ["Go", "C++", "Python", "Distributed Systems", "Kubernetes", "GCP"],
    applyUrl: "https://careers.google.com/",
  },
  {
    id: "job-stripe-fullstack",
    title: "Software Engineer — Core Platform Infrastructure",
    company: "Stripe",
    companyTier: "Mid-Market Unicorn",
    location: "Seattle, WA / Remote, USA",
    country: "United States",
    city: "Seattle, WA",
    workMode: "Remote",
    type: "Full-time",
    ...
    recruiterTitle: "Staff Technical Recruiter — Infrastructure",
    recruiterEmail: "mthorne@stripe.com",
    recruiterLinkedInSearch: "https://www.linkedin.com/search/results/people/?keywords=Stripe+Technical+Recruiter+Seattle",
    skills: ["TypeScript", "React", "Ruby", "PostgreSQL", "Distributed Systems", "AWS"],
